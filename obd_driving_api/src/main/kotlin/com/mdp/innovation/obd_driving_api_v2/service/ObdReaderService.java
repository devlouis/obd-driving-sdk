...
*/
    ...
    private void executeCommand() {
        ...
        ArrayList<ObdCommand> commands = (ArrayList<ObdCommand>) ObdConfig.getCommandCustom().clone();
        int count = 0;

        L.i(" shouldContinue::____ " + shouldContinue );
        while (mSocket != null && mSocket.isConnected() && commands.size() > count && isConnected && ObdPreferences.get(getApplicationContext()).getServiceRunningStatus() && shouldContinue) {
            ...
            //if (shouldContinue){
                try {
                    ...
                    if (command.getName() == "Vehicle Speed")
                        Thread.sleep(1000);
...
*/
     ...
     */
    private Integer NOTIFICATION_ID = 12345678;
    private String CHANNEL_ID = "channel_001";
    private String PACKAGE_NAME = "com.mdp.innovation.obd_driving_api_v2.intentService";
    private String EXTRA_STARTED_FROM_NOTIFICATION = PACKAGE_NAME.toString() + ".started_from_notification";
