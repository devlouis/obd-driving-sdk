package com.mdp.innovation.obd_driving_api_v2.trip;
...
import com.mdp.innovation.obd_driving_api.enums.FuelType;
...
import com.mdp.innovation.obd_driving_api.commands.engine.MassAirFlowCommand;
import com.mdp.innovation.obd_driving_api.commands.engine.RPMCommand;
import com.mdp.innovation.obd_driving_api.commands.engine.RuntimeCommand;
import com.mdp.innovation.obd_driving_api.commands.fuel.FindFuelTypeCommand;
...
public class TripRecord implements DefineObdReader {
   ...
   private ArrayList<ObdCommand> mObdCommandArrayList;
    ...
    public String toString() {
        return "OBD data ::" +
                "\n" + AvailableCommandNames.VIN.getValue() + ":  " + getmVehicleIdentificationNumber() +
